...
<spring:message code="agent.terms" var="terms"/>
...
<form:form action="agent/register.do" modelAttribute="actorForm" >
	...
	<form:label path="phone">
		<spring:message code="agent.phone" />
	</form:label>	
	...
	<acme:password code="agent.confirmPassword" path="confirmPassword"/>
	<br />
	
	<spring:message code ="agent.check"/>
	...
	<input type="button" name="cancel"
		value="<spring:message code="agent.cancel" />"
...
<jstl:otherwise>
<spring:message code="agent.permision" />
</jstl:otherwise>
</jstl:choose>
